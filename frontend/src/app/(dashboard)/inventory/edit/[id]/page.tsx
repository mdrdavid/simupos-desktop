...
export default function EditItemPage() {
  ...
  const { updateItem, getItem } = useData();
    ...
    const fetchItem = async () => {
      try {
        ...
        setFormData({
          ...
          sellingPrice: fetchedItem.sellingPrice.toString(),
          costPrice: fetchedItem.purchasePrice?.toString() || "",
          stockQuantity: fetchedItem.stockQuantity?.toString() || "",
          category: fetchedItem.category || "",
          productType: fetchedItem.productType || "retail",
          unit: fetchedItem.unit || "",
          barcode: fetchedItem.barcode || "",
          description: (fetchedItem as any).description || "",
          supplierId: (fetchedItem as any).supplierId || "",
        });
      } catch (error) {
        toast({
          title: "Error",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await updateItem(params.id as string, itemData);
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    value={formatNumberWithCommas(formData.stockQuantity)}
                    onChange={(e) =>
