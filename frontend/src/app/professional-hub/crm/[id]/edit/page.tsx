...
import { CalendarIcon, ArrowLeft, Save, Edit } from "lucide-react"
...
export default function EditProfessionalCustomerPage() {
  const router = useRouter()
  const params = useParams()
  const customerId = params.id as string
  const { fetchCustomerById, updateCustomer } = useCRM()
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (customer) {
          ...
          if (customer.birthday) {
            setBirthday(new Date(customer.birthday))
          }
        } else {
    ...
    loadCustomer()
  }, [customerId, fetchCustomerById, router])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/professional-hub/crm/${customerId}`)
    } catch (error) {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6 lg:p-8 max-w-3xl pb-24">
      ...
      <div className="flex items-center gap-4 mb-8">
        <Link href={`/professional-hub/crm/${customerId}`}>
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Update customer details for {formData.name}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardHeader className="bg-gray-50/50 border-b border-gray-100">
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <CardDescription>Update identification and contact info</CardDescription>
                </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-6">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Enter any specific preferences..."
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:justify-end">
            <Link href={`/professional-hub/crm/${customerId}`} className="w-full sm:w-auto">
