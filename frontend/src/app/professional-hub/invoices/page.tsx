...
import { Search, Plus, Eye, Edit, Trash2, Filter, Calendar, User, DollarSign } from "lucide-react"
...
export default function InvoicesPage() {
  const { invoices, deleteInvoice } = useWeldingFinancials()
  ...
  const filteredInvoices = invoices.filter((invoice) => {
    ...
    const matchesStandalone =
      standaloneFilter === "all" || (standaloneFilter === "standalone" && invoice.isStandalone)
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-4">
          <Link href="/professional-hub/invoices/create-standalone">
            <Button variant="outline">
              <Plus className="w-4 h-4 mr-2" />
              Create Standalone Invoice
            </Button>
          </Link>
          <Link href="/professional-hub/invoices/create">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      {invoice.isStandalone && <Badge className="bg-blue-100 text-blue-800">Standalone</Badge>}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        <span>Balance: UGX {invoice.balanceDue.toLocaleString()}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Link href={`/professional-hub/invoices/${invoice.id}`}>
                          <Button variant="outline" size="sm">
                            <Eye className="w-4 h-4 mr-1" />
                            View
                          </Button>
                        </Link>
                        <Link href={`/professional-hub/invoices/${invoice.id}/edit`}>
                          <Button variant="outline" size="sm">
