...
import { RestockDialog } from "@/components/welding/RestockDialog";
import { Skeleton } from "@/components/ui/skeleton";

export default function WeldingMaterialsPage() {
  const { materialStock, deleteMaterialStockItem, loadingMaterialStock } =
    useWelding();
  ...
  const lowStockItems = materialStock.filter(
    (item) =>
      item.lowStockThreshold && item.quantityInStock <= item.lowStockThreshold
  );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Manage welding materials inventory
          </p>
        </div>
        <Link href="/professional-hub/materials/create">
          <Button>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {material.supplierInfo || "Not specified"}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">
                    ...
                    {material.notes && (
                      <p className="text-gray-600 mb-4">{material.notes}</p>
                    )}

                    <div className="flex gap-2">
                      <RestockDialog material={material} />
                      <Link href={`/professional-hub/materials/${material.id}/edit`}>
